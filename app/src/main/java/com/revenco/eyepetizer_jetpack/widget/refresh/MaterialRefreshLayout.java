...
package com.revenco.eyepetizer_jetpack.widget.refresh;
 ...
 * @author chenqi
 */
public class MaterialRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    MaterialCircleImageView mCircleView;
    ...
    void reset() {
        ...
        if (mScale) {
            ...
            LogUtil.INSTANCE.i("reset====>mOriginalOffsetTop="+mOriginalOffsetTop);
            LogUtil.INSTANCE.i("reset====>mCurrentTargetOffsetTop="+mCurrentTargetOffsetTop);
    ...
    private void createProgressView() {
        mCircleView = new MaterialCircleImageView(getContext(), CIRCLE_BG_LIGHT);
        mProgress = new MaterialProgressDrawable(getContext());
        mProgress.setStyle(MaterialProgressDrawable.DEFAULT);
        mCircleView.setImageDrawable(mProgress);
        mCircleView.setVisibility(View.GONE);
        addView(mCircleView);
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        LogUtil.INSTANCE.i("onTouchEvent=======>");
        final int action = ev.getActionMasked();
        int pointerIndex = -1;
    ...
    private void startDragging(float y) {
        ...
        if (yDiff > mTouchSlop && !mIsBeingDragged) {
          ...
          //todo   mTarget.setTranslationY(yDiff);
        }
    }
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(@NonNull MaterialRefreshLayout parent, @Nullable View child);
    }
}
